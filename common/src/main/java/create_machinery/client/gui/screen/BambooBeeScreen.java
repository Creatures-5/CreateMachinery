...
import create_machinery.client.gui.screen.widgets.ToggleImageButton;
...
public class BambooBeeScreen extends VehicleScreen {
    ...
    private static final Component TEXT_HELP = Component.translatable("gui.create_machinery.bamboo_bee.help");
    private static final Component TEXT_WHITELIST = Component.translatable("gui.create_machinery.bamboo_bee.whitelist");
    private static final Component TEXT_BLACKLIST = Component.translatable("gui.create_machinery.bamboo_bee.blacklist");
    private static final Component TEXT_FILTER_NAME = Component.translatable("gui.create_machinery.bamboo_bee.filter.name");
    private static final Component TEXT_FILTER_TAG = Component.translatable("gui.create_machinery.bamboo_bee.filter.tag");
    ...
    protected void init() {
        ...
        addImageButton(50, 20 + 36, c.order.ordinal() * 16 + 64, 80, b -> {
            ...
            c.setDirty();
            init();
        }, Component.translatable("gui.create_machinery.bamboo_bee.order." + c.order.name().toLowerCase(Locale.ROOT)), false);
