...
public class HalfTrackRenderer<T extends HalfTrack> extends MachineryRenderer<T> {
    private static final ResourceLocation ID = Common.locate("half_track");
    ...
    public HalfTrackRenderer(EntityRendererProvider.Context context) {
        super(context);
