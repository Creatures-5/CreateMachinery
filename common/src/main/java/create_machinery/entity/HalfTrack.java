...
public class HalfTrack extends MachineEntity {
    ...
    protected void updateController() {
        ...
        if (newDrillY != drillY || newDilling != drilling) {
            drillY = newDrillY;
            drilling = newDilling;
            NetworkHandler.sendToServer(new HalfTrackControlsUpdate(drillY, drilling));
        }
    ...
    public void toggleDrill() {
        ...
        if (pilot != null) {
            pilot.sendSystemMessage(Component.translatable(drillOn ? "create_machinery.half_track.drill_on" : "create_machinery.half_track.drill_off"));
        }
    }
